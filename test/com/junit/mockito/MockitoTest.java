...
public class MockitoTest  {
	...
	public void test1()  {
		//  create mock
		ClassToTest test = mock(ClassToTest.class);
	...
	public void testReturnValueInDependentOnMethodParameter2()  {
		Comparable<ClassToTest> c= mock(Comparable.class);
		when(c.compareTo(isA(ClassToTest.class))).thenReturn(0);
		//assert
		assertEquals(0, c.compareTo(new ClassToTest(1)));
	}
